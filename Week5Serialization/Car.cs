...
namespace Week5Serialization
{
	...
	public class Car : Vehicle
	{
		...
		public Car(Guid id, DateTimeOffset? dateOfManufacture) : base(id, dateOfManufacture)
		{
		...
		public Car(Guid id, DateTimeOffset? dateOfManufacture, string name) : base(id, dateOfManufacture, name)
		{
